...
public class Web3jUtil {
	...
	private static String SCAN_ETHERNUM_URL = "http://127.0.0.1:8545/"; // 자신의 test 블록체인 서버
	private static String status_err = "-100";
	private static String status_ok = "000";
	
	public static void main(String[] args) {
		String jsonParam = "{\"params\":\"0x8fb40485f0b852b626b3b24ebff9c78500b1df71\",\"id\":\"111222333\"}";
	...
	public static Web3j init() {
		...
		try {
			web3 = Web3j.build(new HttpService(SCAN_ETHERNUM_URL));
		} catch (Exception e) {
