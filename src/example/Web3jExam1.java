 ...
 */
public class Web3jExam1 {

    private static final int COUNT = 10;

    private static Logger log = LoggerFactory.getLogger(Web3jExam1.class);

    private final Web3j web3j;

    public Web3jExam1() {
        web3j = Web3j.build(new HttpService("http://127.0.0.1:8545"));  // defaults to http://localhost:8545/
    }
